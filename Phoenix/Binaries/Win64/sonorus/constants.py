...
# Optional cooked package/container ID for the Sonorus Blueprint mod package.
# Leave as None until the package has actually been cooked and verified.
SONORUS_MOD_PACKAGE_ID = None
...
EMOTE_TAGS_PROMPT = ", ".join(f"[{tag}]" for tag in EMOTE_TAGS)
