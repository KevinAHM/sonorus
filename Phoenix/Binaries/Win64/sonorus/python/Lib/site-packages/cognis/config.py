...
# Categories tuned for durable Sonorus NPC memories.
DEFAULT_CATEGORIES = {
    "lore": "Durable backstory or exposition about the world, Hogwarts, places, magic, families, identities, secrets, possessions, or a character's past",
    "relationship": "Durable relationship changes, trust, conflict, loyalty, debts, promises, and alliances",
    "preference": "Stable likes, dislikes, fears, values, tastes, and recurring opinions",
    "milestone": "Completed memorable shared experiences or resolved outcomes worth recalling later",
}
...
class CognisConfig:
    ...
    # Embedding. Sonorus uses OpenAI-compatible providers only.
    ...
    # LLM for extraction. Sonorus overrides this from memory.graphiti_small_model.
